export const dictionaries = {
  en: {
    ...
    products: {
      ...
      items: [
        { name: "Cups", info: "Cold & hot drink cups, lids available.", image: "https://images.unsplash.com/photo-1579932072233-9087a3c3c137" },
        { name: "Plates & bowls", info: "Disposable plates and bowls for daily use.", image: "https://images.unsplash.com/photo-1627906233357-585c57ac4561" },
        { name: "Containers", info: "Food containers for takeaway & delivery.", image: "https://images.unsplash.com/photo-1665451994514-6cec43304561" },
        { name: "Aluminum trays", info: "Heat-friendly trays and foil options.", image: "https://images.unsplash.com/photo-1622373229692-7f985a57de9c" },
        { name: "Cutlery", info: "Disposable spoons, forks and knives.", image: "https://images.unsplash.com/photo-1588078574169-34900b445512" },
        { name: "Packaging", info: "Simple packaging solutions for shops.", image: "https://images.unsplash.com/photo-1557343213-4b0b143715e5" },
      ],
      badges: {
        bulk: "Bulk",
        quick: "Quick order"
  ...
  ur: {
    ...
    products: {
      ...
      items: [
        { name: "کپ", info: "ٹھنڈے اور گرم مشروبات کے کپ، ڈھکن دستیاب ہیں۔", image: "https://images.unsplash.com/photo-1579932072233-9087a3c3c137" },
        { name: "پلیٹیں اور پیالے", info: "روزانہ استعمال کے لیے ڈسپوزایبل پلیٹیں اور پیالے۔", image: "https://images.unsplash.com/photo-1627906233357-585c57ac4561" },
        { name: "کنٹینرز", info: "کھانے کے پارسل اور ڈلیوری کے لیے کنٹینرز۔", image: "https://images.unsplash.com/photo-1665451994514-6cec43304561" },
        { name: "ایلومینیم ٹرے", info: "کھانا گرم رکھنے والی ٹرے اور فوائل۔", image: "https://images.unsplash.com/photo-1622373229692-7f985a57de9c" },
        { name: "چمچ اور کانٹے", info: "ڈسپوزایبل چمچ، کانٹے اور چھری۔", image: "https://images.unsplash.com/photo-1588078574169-34900b445512" },
        { name: "پیکیجنگ", info: "دکانوں کے لیے سادہ پیکیجنگ کا سامان۔", image: "https://images.unsplash.com/photo-1557343213-4b0b143715e5" },
      ],
      badges: {
        bulk: "تھوک",
        quick: "فوری آرڈر"
