export const dictionaries = {
  en: {
    ...
    products: {
      ...
      items: [
        { name: "Cups", info: "Cold & hot drink cups, lids available.", image: "https://images.unsplash.com/photo-1589711000529-8ab3c49c3e98" },
        { name: "Plates & bowls", info: "Disposable plates and bowls for daily use.", image: "https://images.unsplash.com/photo-1617936257597-1246a4c337a1" },
        { name: "Containers", info: "Food containers for takeaway & delivery.", image: "https://images.unsplash.com/photo-1584950346386-83c2a3b0a03d" },
        { name: "Aluminum trays", info: "Heat-friendly trays and foil options.", image: "https://images.unsplash.com/photo-1627806533829-b1a7c85b4b6b" },
        { name: "Cutlery", info: "Disposable spoons, forks and knives.", image: "https://images.unsplash.com/photo-1617936257597-1246a4c337a1" },
        { name: "Packaging", info: "Simple packaging solutions for shops.", image: "https://images.unsplash.com/photo-1589711000529-8ab3c49c3e98" },
      ],
      badges: {
        bulk: "Bulk",
        quick: "Quick order"
  ...
  ur: {
    ...
    products: {
      ...
      items: [
        { name: "کپ", info: "ٹھنڈے اور گرم مشروبات کے کپ، ڈھکن دستیاب ہیں۔", image: "https://images.unsplash.com/photo-1589711000529-8ab3c49c3e98" },
        { name: "پلیٹیں اور پیالے", info: "روزانہ استعمال کے لیے ڈسپوزایبل پلیٹیں اور پیالے۔", image: "https://images.unsplash.com/photo-1617936257597-1246a4c337a1" },
        { name: "کنٹینرز", info: "کھانے کے پارسل اور ڈلیوری کے لیے کنٹینرز۔", image: "https://images.unsplash.com/photo-1584950346386-83c2a3b0a03d" },
        { name: "ایلومینیم ٹرے", info: "کھانا گرم رکھنے والی ٹرے اور فوائل۔", image: "https://images.unsplash.com/photo-1627806533829-b1a7c85b4b6b" },
        { name: "چمچ اور کانٹے", info: "ڈسپوزایبل چمچ، کانٹے اور چھری۔", image: "https://images.unsplash.com/photo-1617936257597-1246a4c337a1" },
        { name: "پیکیجنگ", info: "دکانوں کے لیے سادہ پیکیجنگ کا سامان۔", image: "https://images.unsplash.com/photo-1589711000529-8ab3c49c3e98" },
      ],
      badges: {
        bulk: "تھوک",
        quick: "فوری آرڈر"
