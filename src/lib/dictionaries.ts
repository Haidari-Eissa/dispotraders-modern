export const dictionaries = {
  en: {
    ...
    hero: {
      kicker: "Disposable Supplier - Quetta",
      pill_delivery: "Fast delivery in Quetta",
      pill_hygiene: "Clean & hygienic",
      pill_price: "Affordable prices",
      title_start: "Disposable cups, plates, and packaging",
      title_highlight: "for Quetta",
      title_end: "",
      description: "Fast delivery. Easy WhatsApp order.",
      quick_reply: "WhatsApp in minutes",
      audience_short: "Shops, events, homes",
  ...
  ur: {
    ...
    hero: {
      kicker: "ڈسپوزایبل سپلائر - کوئٹہ",
      pill_delivery: "کوئٹہ میں تیز ترین ترسیل",
      pill_hygiene: "صاف اور شفاف",
      pill_price: "مناسب قیمتیں",
      title_start: "ڈسپوزایبل کپ، پلیٹیں اور پیکیجنگ",
      title_highlight: "کوئٹہ کے لیے",
      title_end: "",
      description: "تیز ترسیل۔ آسان واٹس ایپ آرڈر۔",
      quick_reply: "منٹوں میں واٹس ایپ جواب",
      audience_short: "دکانیں، تقریبات، گھر",
