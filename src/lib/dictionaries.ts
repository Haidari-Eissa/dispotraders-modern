export const dictionaries = {
  en: {
    ...
    products: {
      ...
      items: [
        { name: "Cups", info: "Cold & hot drink cups, lids available.", image: "https://images.unsplash.com/photo-1545161296-d9c2c241f2ad" },
        { name: "Plates & bowls", info: "Disposable plates and bowls for daily use.", image: "https://images.unsplash.com/photo-1565895405138-6c3a1555da6a" },
        { name: "Containers", info: "Food containers for takeaway & delivery.", image: "https://images.unsplash.com/photo-1607513746874-793399fd972b" },
        { name: "Aluminum trays", info: "Heat-friendly trays and foil options.", image: "https://images.unsplash.com/photo-1588625348083-38505a27c793" },
        { name: "Cutlery", info: "Disposable spoons, forks and knives.", image: "https://images.unsplash.com/photo-1558642769-14a070b43343" },
        { name: "Packaging", info: "Simple packaging solutions for shops.", image: "https://images.unsplash.com/photo-1594705489720-37b512a8a183" },
      ],
      badges: {
        bulk: "Bulk",
        quick: "Quick order"
  ...
  ur: {
    ...
    products: {
      ...
      items: [
        { name: "کپ", info: "ٹھنڈے اور گرم مشروبات کے کپ، ڈھکن دستیاب ہیں۔", image: "https://images.unsplash.com/photo-1545161296-d9c2c241f2ad" },
        { name: "پلیٹیں اور پیالے", info: "روزانہ استعمال کے لیے ڈسپوزایبل پلیٹیں اور پیالے۔", image: "https://images.unsplash.com/photo-1565895405138-6c3a1555da6a" },
        { name: "کنٹینرز", info: "کھانے کے پارسل اور ڈلیوری کے لیے کنٹینرز۔", image: "https://images.unsplash.com/photo-1607513746874-793399fd972b" },
        { name: "ایلومینیم ٹرے", info: "کھانا گرم رکھنے والی ٹرے اور فوائل۔", image: "https://images.unsplash.com/photo-1588625348083-38505a27c793" },
        { name: "چمچ اور کانٹے", info: "ڈسپوزایبل چمچ، کانٹے اور چھری۔", image: "https://images.unsplash.com/photo-1558642769-14a070b43343" },
        { name: "پیکیجنگ", info: "دکانوں کے لیے سادہ پیکیجنگ کا سامان۔", image: "https://images.unsplash.com/photo-1594705489720-37b512a8a183" },
      ],
      badges: {
        bulk: "تھوک",
        quick: "فوری آرڈر"
